  ...
  return (
    <div className="max-container my-20">
      <SectionHeading
        ...
        subtitle="Leveraging cutting-edge AI technology to create personalized learning experiences that adapt to each student's unique needs."
        icon={
      ...
      {/* Benefits */}
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20 mt-20">
