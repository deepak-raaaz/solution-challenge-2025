        ...
        <div className="flex items-start">
          ...
          >
            {lesson.status === 'completed' ? (
              ...
              <span className="text-white font-bold text-lg">{lesson.id.split('-')[0]}</span>
            ) : (
          ...
          <div className="ml-6 flex-1">
            <div
              className={`bg-gray-700/20 border rounded-lg p-4 ${
                lesson.status === 'in-progress' ? 'border-blue-500' : 'border-gray-600/40'
              }`}
            >
