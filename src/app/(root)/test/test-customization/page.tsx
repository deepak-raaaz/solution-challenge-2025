...
export default function TestCustomizationPage() {
  ...
  useEffect(() => {
    ...
    if (query) {
      // Convert hyphenated query to readable format and set as custom topics
     
      setQuery(decodeURIComponent(query));

      // Try to automatically select relevant subjects based on the query
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Create URL with test configuration
