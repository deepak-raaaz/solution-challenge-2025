      ...
      <div className="max-container">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold  dark:text-white mb-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent">
            Education Inequality: A Global Crisis
          </h2>
          <p className="text-lg text-gray-600 dark:text-blue-100">
            Despite advances in technology, quality education remains inaccessible to millions worldwide, creating a widening gap in opportunities and outcomes.
          </p>
        </div>
