...
const MobileNav = () => {
  ...
  return (
    <div className="lg:hidden">
      ...
      {/* Navigation Menu */}
      <div
        className={`fixed top-16 right-0 h-[calc(100vh-4rem)] w-64 bg-background border-l border-border transform transition-transform duration-300 ease-in-out z-50 flex flex-col ${
