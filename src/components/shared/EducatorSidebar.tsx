...
const EducatorSidebar = () => {
  ...
  const resourceItems: NavItem[] = [
    {
      href: "/educator/resource-library",
  ...
  return (
    <nav className="hidden lg:flex lg:flex-col lg:w-64 h-screen bg-white dark:bg-gray-800/50 border-r border-gray-200 dark:border-gray-700 overflow-y-auto shadow-sm fixed">
      {/* Logo Section */}
